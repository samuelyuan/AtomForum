// Original code from https://github.com/jbrooksuk/node-summary

var _ = require('lodash');
const Tokenizer = require('sbd');

// http://stackoverflow.com/a/1885660/394013
...
const splitContentToSentences = (content, callback) => {
    ...
    callback(Tokenizer.sentences(content, {
...
const getSortedSentencesHelper = (paragraph, sentences_dict, n, callback) => {
    splitContentToSentences(paragraph, sentences => {
        ...
        callback(_.map(sentence_scores, 'sentence')) // callback with sorted_sentences. map is former .pluck
    })
}
...
exports.getSortedSentences = (content, n, callback, sentences_dict) => {
    ...
    getSentencesRanks(
        content,
        dict => {
            getSortedSentencesHelper(content, dict, n, sorted_sentences => {
                if (sorted_sentences === '') {
